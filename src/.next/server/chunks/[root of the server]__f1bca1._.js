...
"[project]/app/api/cards/route.tsx [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        if (filter === "all" || filter === null) {
            ...
            cards = cards.filter((card)=>card.completed.toString() === "true");
        } else if (filter === "false") {
            cards = cards.filter((card)=>card.completed.toString() === "false");
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            cards
        }, {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__f1bca1._.js.map